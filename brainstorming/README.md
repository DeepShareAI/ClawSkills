...
- `scripts/lib.js` — pure helpers (tz resolution, the relative-date anchor, dedup key, prompt-template assembly, the `formatDigest` Agent Chat markdown, TTL pruning).
